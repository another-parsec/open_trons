...
def uploadstringasfiletodropbox(name, string_data):
    ...
    headers = {'Authorization': 'Bearer LkXNCLWcQpkAAAAAAAAAAXMSKZLH5QblvBKRqON2m5HC74XrMYSObCQYUVonxWu_',
...
# pcr_output_sheet.to_csv(export_file_path, index=False, header=True)
